...
<style>
  ...
  /* Keeps each abstract and its resource links in one soft visual callout. */
...
<table border="0" cellpadding="12" cellspacing="0" style="border: none; border-collapse: collapse; width: 100%; font-size: inherit;">
  <tr>
    ...
    <td class="publication-abstract" width="62%" valign="top" style="border: none; font-size: inherit;">
